...
class SifchainConnector(ConnectorBase):
    """
    SifchainInFlightOrder connects with Sifchain gateway APIs and provides pricing, user account tracking and trading
    functionality.
    """
    ...
    def __init__(self,
                 sifchain_wallet_address: str,
                 sifchain_wallet_seeds: str,
        ...
        """
        super().__init__()
        self._sifchain_wallet_address = sifchain_wallet_address
        self._sifchain_wallet_seeds = sifchain_wallet_seeds
    ...
    async def _create_order(self,
        ...
        try:
            order_result = await self._api_request("post", "sifchain/trade", api_params)
    ...
    def start_tracking_order(self,
        ...
        """
        self._in_flight_orders[order_id] = SifchainInFlightOrder(
    ...
    async def _update_balances(self):
        ...
        resp_json = await self._api_request("post",
                                            "sifchain/balances",
                                            {"address": self._sifchain_wallet_address})
    ...
    @property
    def in_flight_orders(self) -> Dict[str, SifchainInFlightOrder]:
